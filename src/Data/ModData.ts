...
export const ModData: {[mod: string]: Mod[]} = {
	["ECM"]:[ 
      ...
      },
	  {
        ...
        "Description": "An API for creating new items and icons for said items. Very configurable, ask on discord for information on how to use. Still in progress, but it's basically done apart from adding new things and making sure its bug free.
